...
class mycpu(val config: mycpuConfig) extends Component{

  //Legacy constructor
  def this(axiFrequency: HertzNumber) {
    this(mycpuConfig.default.copy(axiFrequency = axiFrequency))
  }
...
//     val config = SpinalConfig()
//     config.generateVerilog({
//       val toplevel = new mycpu(mycpuConfig.default.copy(sdramLayout = IS42x160G.layout))
//       toplevel
//     })
//   }
// }
...
//     SimConfig.allOptimisation.compile(new mycpu(mycpuConfig.default)).doSimUntilVoid{dut =>
//       val mainClkPeriod = (1e12/dut.config.axiFrequency.toDouble).toLong
//       val jtagClkPeriod = mainClkPeriod*4
//       val uartBaudRate = 115200
//       val uartBaudPeriod = (1e12/uartBaudRate).toLong

//       val clockDomain = ClockDomain(dut.io.axiClk, dut.io.-  `1``)
